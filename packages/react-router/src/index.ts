...
/**
 * Reactive streaming text hook with React Router v7 defaults.
...
/**
 * Reactive structured streaming hook with React Router v7 defaults.
...
/**
 * Multi-turn chat hook with React Router v7 defaults.
...
/**
 * Multi-model race hook with React Router v7 defaults.
 * Endpoint defaults to `/__aibind__/stream`.
 */
...
/**
 * Inline completions hook with React Router v7 defaults.
