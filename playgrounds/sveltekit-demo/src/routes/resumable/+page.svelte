...
<p class="description">
	This demo shows abort+resume streaming. When you stop a stream, partial text is preserved
	and the server is signaled to halt LLM generation. If the connection drops, auto-reconnect
	kicks in. If reconnection fails, you can manually resume.
</p>
