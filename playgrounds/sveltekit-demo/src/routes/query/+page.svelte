...
<h1>Query Demo</h1>
<p>Test <code>query</code> and <code>structuredQuery</code> remote functions — no streaming, just request/response.</p>

<div class="input-section">
	<textarea bind:value={text} placeholder="Paste or type text to summarize or analyze..." rows="6"></textarea>
	<div class="actions">
		<button onclick={handleSummarize} disabled={loading !== null || !text.trim()}>
